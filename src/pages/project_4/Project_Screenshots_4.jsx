...
import Screenshot1Img from '../../assets/Screenshot 1.png';
import Screenshot2Img from '../../assets/Screenshot 2.png';
import Screenshot3Img from '../../assets/Screenshot 3.png';
...
const Project_ScreenshotsData = [
    {
        ...
        viewLink: 'https://docs.google.com/spreadsheets/d/1tnpzcXhgS0GyZhFOvCNP4e8ngAQeXYxzw-vS7y3czHY/edit?usp=sharing'
    },
    {
        id: 2,
        image: Screenshot2Img,
        title: 'Graphics',
        description: 'Developed a series of 20 unique and engaging graphics for social media, tailored to enhance brand visibility and audience engagement. The graphics were created to align with the brand\'s visual identity and marketing goals.',
        viewLink: 'https://drive.google.com/drive/folders/1k8rn-2ko1t30slluQZr6ooyIrxdP5Q1N?usp=sharing',
    },

    {
        ...
        title: 'Videos',
        description: 'Developed a series of engaging video content for Instagram and YouTube to enhance brand visibility and connect with the target audience. The project aimed to increase audience engagement and drive brand awareness across social platforms.',
        viewLink: 'https://drive.google.com/drive/folders/1QGSojwp3HrX3jCwWXmBR5Fy5JoVg7ced?usp=sharing',
    },
];

const Project_Screenshots_4 = () => {
...
export default Project_Screenshots_4;
