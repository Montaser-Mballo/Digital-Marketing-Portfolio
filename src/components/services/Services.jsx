...
const Services = () => {
    ...
    const handleClickOutside = (event) => {
        if (event.target.classList.contains('services__modal')) {
            setToggleState(0);  // Close modal if clicked outside the content
        }
    };
        ...
        <section className="services section" id="services">
            ...
            <div className="services__container container grid">
                <div className="services__content">
                    ...
                    <div className={toggleState === 1 ? "services__modal active-modal" : "services__modal"} onClick={handleClickOutside}>
                ...
                <div className="services__content">
                    ...
                    <div className={toggleState === 2 ? "services__modal active-modal" : "services__modal"} onClick={handleClickOutside}>
                        <div className="services__modal-content">
                            <HiX onClick={() => toggleTab(0)} className="services__modal-close" />
                ...
                <div className="services__content">
                    ...
                    <div className={toggleState === 3 ? "services__modal active-modal" : "services__modal"} onClick={handleClickOutside}>
                        <div className="services__modal-content">
                            <HiX onClick={() => toggleTab(0)} className="services__modal-close" />
                            <h3 className="services__modal-title">Branding</h3>
                            <p className="services__modal-description">
                                Over 3 years of experience in branding providing quality work.
                            </p>
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    <HiOutlineCheckCircle className="services__modal-icon" />
